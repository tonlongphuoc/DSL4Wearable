...
/**
 * This is the item provider adapter for a {@link iotwearable.model.iotw.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider extends InputControlItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_pin1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_pin1_feature", "_UI_Button_type"),
				 IotwPackage.Literals.BUTTON__PIN1,
				 true,
				 false,
				 false,
