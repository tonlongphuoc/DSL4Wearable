...
/**
 * This is the item provider adapter for a {@link iotwearable.model.iotw.LED} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LEDItemProvider extends OutputControlItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LED_pin1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LED_pin1_feature", "_UI_LED_type"),
				 IotwPackage.Literals.LED__PIN1,
				 true,
				 false,
				 false,
	...
	protected void addPin2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LED_pin2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LED_pin2_feature", "_UI_LED_type"),
				 IotwPackage.Literals.LED__PIN2,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
