...
import iotwearable.editor.factory.I2CLCD2004Factory;
...
public class CreateMainboardContextMenuAction extends WorkbenchPartAction {

	public static final String ID_AddBuzzer = "AddBuzzer";
	public static final String ID_AddI2CLCD2004 = "AddI2CLCD2004";
	...
	public CreateMainboardContextMenuAction(IWorkbenchPart part, String Id , Mainboard mainboard) {
		super(part);
		...
		case ID_AddBuzzer:
			...
			setText("Add Buzze");
			break;
		case ID_AddI2CLCD2004:
			setId(Id);
			setText("Add I2C LCD 2004");
			break;
	...
	public void run() {
		...
		case ID_AddBuzzer:
			...
			break;
		case ID_AddI2CLCD2004:
			tool = new CreationTool((CreationFactory) new I2CLCD2004Factory());;
			editor.getEditDomain().setActiveTool(tool);
			break;
		case ID_AddKeypad4x4:
	...
	protected boolean calculateEnabled() {
		...
		case ID_AddBuzzer:
			...
			break;
		case ID_AddI2CLCD2004:
			enable = checkCalculateEnabledI2CLCD2004();
			break;
		case ID_AddBluetoothHC06:
	...
	private boolean checkCalculateEnabledI2CLCD2004()
	{
		for(IOControl control : mainboard.getControls())
		{
	...
	private boolean checkCalculateEnabledBluetooth()
	{
		...
		{
			if(control instanceof  BluetoothHC06)
				return false;
		}
		return true;
	}
