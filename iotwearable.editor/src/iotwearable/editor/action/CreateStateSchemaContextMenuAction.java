...
public class CreateStateSchemaContextMenuAction extends WorkbenchPartAction {
	...
	public CreateStateSchemaContextMenuAction(IWorkbenchPart part, String Id, StateSchema stateSchema) {
		super(part);
		this.Id=Id;
	...
	{
		for(StateControl control: stateSchema.getControls())
