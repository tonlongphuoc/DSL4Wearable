...
public class IotwFactoryImpl extends EFactoryImpl implements IotwFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case IotwPackage.DATA_EXPLORER: return createDataExplorer();
			...
			case IotwPackage.I2CLCD2004: return createI2CLCD2004();
	...
	public DataExplorer createDataExplorer() {
		DataExplorerImpl dataExplorer = new DataExplorerImpl();
		return dataExplorer;
	}
	 ...
	 * @generated
	 */
	public I2CLCD2004 createI2CLCD2004() {
		I2CLCD2004Impl i2CLCD2004 = new I2CLCD2004Impl();
		return i2CLCD2004;
	}
