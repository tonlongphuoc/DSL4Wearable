...
public class ConnectionImpl extends MinimalEObjectImpl.Container implements Connection {
	...
	public Control getSource() {
		if (source != null && source.eIsProxy()) {
			...
			source = (Control)eResolveProxy(oldSource);
			if (source != oldSource) {
				if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public void setSource(Control newSource) {
		Control oldSource = source;
		source = newSource;
		if (eNotificationRequired())
	...
	public Control getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			target = (Control)eResolveProxy(oldTarget);
			if (target != oldTarget) {
				if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case IotwPackage.CONNECTION__ROUTER_KIND:
				...
				return;
			case IotwPackage.CONNECTION__SOURCE:
				setSource((Control)newValue);
				return;
			case IotwPackage.CONNECTION__TARGET:
				setTarget((Control)newValue);
				return;
			case IotwPackage.CONNECTION__KIND:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case IotwPackage.CONNECTION__ROUTER_KIND:
				...
				return;
			case IotwPackage.CONNECTION__SOURCE:
				setSource((Control)null);
				return;
			case IotwPackage.CONNECTION__TARGET:
				setTarget((Control)null);
				return;
			case IotwPackage.CONNECTION__KIND:
